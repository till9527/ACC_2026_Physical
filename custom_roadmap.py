...
# ==========================================
NODE_DATA_BASE = {
    0: (0.0000, 0.1302, -90.0),
    1: (0.2686, 0.0814, 90.0),
    2: (1.1274, -1.0847, 0.0),
    3: (1.1274, -0.8140, 180.0),
    4: (2.2548, 0.0814, 90.0),
    5: (1.9841, 0.0814, -90.0),
    6: (1.0134, 1.1009, 180.0),
    7: (1.2352, 0.8303, 0.0),
    8: (-0.7489, 1.1009, 180.0),
    9: (-0.7489, 0.8303, 0.0),
    10: (-1.2820, -0.4599, -42.0),
    11: (0.0000, 2.1632, -90.0),
    12: (0.0000, 1.8498, -90.0),
    13: (0.2686, 1.8498, 90.0),
    14: (2.2548, 2.9670, 90.0),
    15: (1.9841, 1.8498, -90.0),
    16: (0.9076, 3.7098, -80.6),
    17: (1.4660, 3.1512, -9.4),
    18: (0.6227, 3.0667, -138.0),
    19: (0.7916, 2.8592, 42.0),
    20: (0.0000, 4.4973, 180.0),
    21: (0.0000, 4.2267, 0.0),
    22: (-1.9841, 2.9670, -90.0),
    23: (-1.7155, 2.9670, 90.0),
}
